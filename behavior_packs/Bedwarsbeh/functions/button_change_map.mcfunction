...
execute @e[type=player,x=-203,y=201,z=-196,r=3,c=1] ~~~ execute @s[tag=op] ~~~ execute @e[type=armor_stand,name=main,scores={gameSTART=0,"地图选择"=0}] ~~~ tellraw @a { "rawtext" : [ { "text" : "§f§l起床战争 >> §e游戏地图已被更改为 §f§kii§r§l§f 随机 §l§kii" } ] }
...
execute @e[type=player,x=-203,y=201,z=-196,r=3,c=1] ~~~ execute @s[tag=op] ~~~ execute @e[type=armor_stand,name=main,scores={gameSTART=0,"地图选择"=2}] ~~~ tellraw @a { "rawtext" : [ { "text" : "§f§l起床战争 >> §e游戏地图已被更改为 §6沙漠" } ] }
