...
execute @a[tag=upgrade_green_protection] ~~~ tellraw @a[scores={"分队"=4}] { "rawtext" : [ { "selector" :  "@a[tag=want_upgrade_protection_green]"},{"translate":"text.tellraw.ingameinfo.team_member_purchase_team_upgrade_protection"}] }
execute @a[tag=upgrade_green_protection] ~~~ playsound note.pling @s ~~~
execute @a[tag=upgrade_green_protection] ~~~ scoreboard players add @s own_xp -300
...
execute @e[type=armor_stand,name=main,scores={game_version=1}] ~~~ execute @a[tag=upgrade_green_protection] ~~~ function team_upgrade_protection
execute @e[type=armor_stand,name=main,scores={game_version=2}] ~~~ execute @a[tag=upgrade_green_protection] ~~~ function team_upgrade_protection_old2
