...
execute @s[scores={分队=1},lm=20] ~~~ tag @s add give_red_stained_glass
execute @s[scores={分队=2},lm=20] ~~~ tag @s add give_blue_stained_glass
execute @s[scores={分队=3},lm=20] ~~~ tag @s add give_yellow_stained_glass
execute @s[scores={分队=4},lm=20] ~~~ tag @s add give_green_stained_glass
execute @s[lm=20] ~~~ tellraw @s { "rawtext" : [{"translate":"text.tellraw.ingameinfo.purchase_stained_glass"} ] }
