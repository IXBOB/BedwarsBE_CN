...
execute @e[type=armor_stand,name=main,scores={game_version=1}] ~~~ execute @a[tag=upgrade_yellow_protection] ~~~ function team_upgrade_protection
execute @e[type=armor_stand,name=main,scores={game_version=2}] ~~~ execute @a[tag=upgrade_yellow_protection] ~~~ function team_upgrade_protection_old2
