#红队陷阱被触发
execute @e[type=armor_stand,name=main,scores={gameSTART=1,"红陷阱等级"=1..3}] ~~~ execute @e[type=player,scores={"分队"=2},x=-5,y=176,z=32,dx=10,dy=22,dz=26] ~~~ title @a[scores={"分队"=1}] title §c§l陷阱触发
execute @e[type=armor_stand,name=main,scores={gameSTART=1,"红陷阱等级"=1..3}] ~~~ execute @e[type=player,scores={"分队"=2},x=-5,y=176,z=32,dx=10,dy=22,dz=26] ~~~ title @a[scores={"分队"=1}] subtitle 一名玩家触发了队伍陷阱
