...
#tellraw获得无敌时间
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @e[type=player,scores={respawning=1,"重生时间"=..-1,"分队"=1..2}] ~~~ tellraw @s { "rawtext" : [ { "text" : "§f§l起床战争 >> §b§l你获得了 3 秒的无敌时间" } ] }
#重生TP红
