...
#红队队伍actionbar
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @a[scores={"分队"=1,"存活"=1},x=-63,y=90,z=-63,dx=126,dy=150,dz=126] ~~~ titleraw @s actionbar { "rawtext" : [{ "text" : "§f队伍:  §c§l红队\n§r§f队伍成员:  §c§l" },{ "selector" :  "@a[scores={分队=1,存活=1}]"},{ "text" : "\n§r§7游戏时间:  " },{ "score" : { "name" : "@s" , "objective" : "game.time.min.2"}},{ "score" : { "name" : "@s" , "objective" : "game.time.min.1"}},{ "text" : " : " },{ "score" : { "name" : "@s" , "objective" : "game.time.sec.2"}},{ "score" : { "name" : "@s" , "objective" : "game.time.sec.1"}},{"text":"\n§r§7击杀数: "},{"score":{"name":"@s","objective":"击杀数"}},{"translate":"%%5%%6%%7%%8","with":{"rawtext":[{"selector":"@s[tag=near_diamond]"},{"selector":"@s[tag=near_diamond]"},{"selector":"@s[tag=near_diamond]"},{"selector":"@s[tag=near_diamond]"},{"text":"\n§r§e钻石生成点等级: "},{ "score" : { "name" : "@s" , "objective" : "钻石等级"}},{"text":"     下一个钻石: "},{ "score" : { "name" : "@s" , "objective" : "钻石time"}}]}},{"translate":"%%5%%6%%7%%8","with":{"rawtext":[{"selector":"@s[tag=near_emerald]"},{"selector":"@s[tag=near_emerald]"},{"selector":"@s[tag=near_emerald]"},{"selector":"@s[tag=near_emerald]"},{"text":"\n§r§e绿宝石生成点等级: "},{ "score" : { "name" : "@s" , "objective" : "绿宝石等级"}},{"text":"     下一个绿宝石: "},{ "score" : { "name" : "@s" , "objective" : "绿宝石time"}}]}}]}
#蓝队队伍actionbar
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @a[scores={"分队"=2,"存活"=1},x=-63,y=90,z=-63,dx=126,dy=150,dz=126] ~~~ titleraw @s actionbar { "rawtext" : [{ "text" : "§f队伍:  §b§l蓝队\n§r§f队伍成员:  §b§l" },{ "selector" :  "@a[scores={分队=2,存活=1}]"},{ "text" : "\n§r§7游戏时间:  " },{ "score" : { "name" : "@s" , "objective" : "game.time.min.2"}},{ "score" : { "name" : "@s" , "objective" : "game.time.min.1"}},{ "text" : " : " },{ "score" : { "name" : "@s" , "objective" : "game.time.sec.2"}},{ "score" : { "name" : "@s" , "objective" : "game.time.sec.1"}},{"text":"\n§r§7击杀数: "},{"score":{"name":"@s","objective":"击杀数"}},{"translate":"%%5%%6%%7%%8","with":{"rawtext":[{"selector":"@s[tag=near_diamond]"},{"selector":"@s[tag=near_diamond]"},{"selector":"@s[tag=near_diamond]"},{"selector":"@s[tag=near_diamond]"},{"text":"\n§r§e钻石生成点等级: "},{ "score" : { "name" : "@s" , "objective" : "钻石等级"}},{"text":"     下一个钻石: "},{ "score" : { "name" : "@s" , "objective" : "钻石time"}}]}},{"translate":"%%5%%6%%7%%8","with":{"rawtext":[{"selector":"@s[tag=near_emerald]"},{"selector":"@s[tag=near_emerald]"},{"selector":"@s[tag=near_emerald]"},{"selector":"@s[tag=near_emerald]"},{"text":"\n§r§e绿宝石生成点等级: "},{ "score" : { "name" : "@s" , "objective" : "绿宝石等级"}},{"text":"     下一个绿宝石: "},{ "score" : { "name" : "@s" , "objective" : "绿宝石time"}}]}}]}
#淘汰后玩家actionbar
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @a[rx=90,rxm=-89,scores={able_to_respawn=0,"出局观战"=1,"存活"=!1}] ~~~ titleraw @s actionbar { "rawtext" : [{ "text" : "§f§l>> 您现在是一名旁观者 <<" },{ "text" : "\n§r§7游戏时间:  " },{ "score" : { "name" : "@s" , "objective" : "game.time.min.2"}},{ "score" : { "name" : "@s" , "objective" : "game.time.min.1"}},{ "text" : " : " },{ "score" : { "name" : "@s" , "objective" : "game.time.sec.2"}},{ "score" : { "name" : "@s" , "objective" : "game.time.sec.1"}},{ "text" : "\n§r§c§l红队剩余玩家: " },{"selector":"@a[scores={分队=1,存活=1}]"},{ "text" : "\n§r§b§l蓝队剩余玩家: " },{"selector":"@a[scores={分队=2,存活=1}]"},{ "text" : "\n§f>> 抬头以返回大厅 <<" } ] }
#clear红队淘汰玩家
...
#删除我的伙伴
effect @e[type=netease:pet] invisibility 9999 255 true
kill @e[type=netease:pet]